...
export default function SingleProductDetail({product}:Readonly<{product: IProductDetail}>) {
  const afterDiscount = (product.price - product.price * product.discountPercentage/100)
    return (
    <>
    ...
    <div className="max-w-7xl px-4 mx-auto 2xl:px-0">
      <div className="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16">
        <div className="shrink-0 max-w-md lg:max-w-lg mx-auto">
          <img className="w-full dark:hidden" src={product?.thumbnail} alt="" />
                  </div>

        <div className="mt-6 sm:mt-8 lg:mt-0 flex flex-col gap-6">
          <h1
          ...
          <div className="mt-4 sm:items-center sm:gap-4 sm:flex">
            ...
            >
              {Intl.NumberFormat('en', {style: "currency", currency:"USD"}).format(afterDiscount)}
            </p>
            ...
            <div className="flex items-center gap-2 mt-2 sm:mt-0">
              <div className="flex items-center gap-1">
...

                {
                  [1,2,3,4,5].map((rate)=>(
                         <svg
                  className= {`size-4 ${Math.round(product.rating)>=rate ? "text-yellow-400" : "text-gray-300"}`}
                  aria-hidden="true"
  ...
  <section className="py-8 bg-white md:py-16 antialiased">
     <div className="mt-6 divide-y divide-gray-200 dark:divide-gray-700 shadow p-5 sm:rounded-lg">
      <div className="gap-3 pb-6 sm:flex sm:items-start">
        <div className="shrink-0 space-y-2 sm:w-48 md:w-72">
          ...
          <div className="inline-flex items-center gap-1">
            <svg className="h-5 w-5 text-teal-700 dark:text-teal-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
              <path
                fill-rule="evenodd"
